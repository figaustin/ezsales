...
<div class="flex font-serif">
    ...
    <div class="mx-auto">
        ...
        <form:form class="mt-20 w-96" action="/employees/add" method="post" modelAttribute="employee">
            <div class="relative z-0 w-full mb-6 group">
                ...
                <form:label path="firstName"
                           ...
                           peer-focus:scale-75 peer-focus:-translate-y-6">First Name
                </form:label>
            </div>
            <div class="relative z-0 w-full mb-6 group">
                ...
                <form:label path="lastName"
                           ...
                           -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600
                           peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0
                           peer-focus:scale-75 peer-focus:-translate-y-6">Last Name
                </form:label>
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="wage" step="0.01"
                       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2
                border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500
                focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                ...
                <label
                        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform
                           -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600
                           peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0
                           peer-focus:scale-75 peer-focus:-translate-y-6">Wage
                </label>
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="pin" min="10000" max="999999"
                       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2
                border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500
                ...
                <label
                        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform
                           -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600
                           peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0
                           peer-focus:scale-75 peer-focus:-translate-y-6">6 Digit PIN #
                </label>
            </div>

            <form:hidden path="business" name="business" value="${business.id}"/>
            <form:hidden path="clockedIn" name="clockedIn" value="false"/>
            <button type="submit"
