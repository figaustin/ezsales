    ...
    <div class="flex-column justify-center w-full">
        ...
        <div class="overflow-auto invoice" name="invoice">
            <table class="overflow-auto border-spacing-5 mx-auto w-full invoiceTable">
                ...
                <tr class="bg-slate-400 text-xl border border-slate-900 invoiceTableHeaderRow">
                    <th>Product</th>
                    <th>Price</th>
                    <th>Actions</th>
                </tr>
            ...
            <div class="ml-80 fixed inset-x-0 bottom-0 bg-slate-300 text-4xl font-serif border-t-2 border-slate-500 flex justify-between items-center p-5">
                <p>Total: </p>
                <button type="button"
                        class="text-2xl text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl hover:text-slate-300 focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg px-10 py-2.5 text-center mr-2 mb-2">
                    Pay
                </button>
            </div>
        </div>
